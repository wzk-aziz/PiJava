 ...
 * @author neder
 */
public class ModifierRdvDocteurController implements Initializable {
    ...
    private int id;
    private RDV rdv = gui.AffichageRdvDocteurController.rdv ;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        System.out.println("heree");
           ...
           FXMLLoader loader = new FXMLLoader();
            ...
            loader.setLocation(getClass().getResource("/gui/AffichageRdvDocteur.fxml"));
          ...
          s.setStarttime(java.sql.Time.valueOf(startR.getValue()));
           ...
           Alert alert = new Alert(Alert.AlertType.INFORMATION);
            ...
            alert.showAndWait();
             ...
             FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/AffichageRdvDocteur.fxml"));
